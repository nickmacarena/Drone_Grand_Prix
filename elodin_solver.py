...
from sim.course import EASY_COURSE              # elodin repo package
...
HOVER_PWM = 1135
CLIMB_PWM_AUTHORITY = 465    # PWM above hover at vertical = +1
THROTTLE_MIN = 1000
THROTTLE_MAX = 1600

GATES = tuple(g.center for g in EASY_COURSE)  # ENU (x, y, z-up) == planner frame
...
def autopilot(update: SensorUpdate) -> RCCommand:
    ...
    return RCCommand(arm=1800, throttle=throttle, pitch=pitch, roll=roll)
